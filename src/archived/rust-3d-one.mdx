...
Till I thought, what if I just make the "3d" part myself. I could prob learn graphics programming (:skull:) and then make a 3 camera system, connect each camera to a screen, and beautiful "3d".
