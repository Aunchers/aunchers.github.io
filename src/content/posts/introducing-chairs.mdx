...
<Callout type="info" title="title update">
  this post was originally titled "Introducing CHAIRS / aunchers". renamed to focus on features over introduction.
</Callout>
